...
class PlaygroundHandler:
    ...
    def generate_llm_codes(
        ...
        try:
            ...
            # Call the LLM handler - note: the actual API may vary
            # Adjust parameters based on what llm_handler.generate_with_5hz_lm actually accepts
            metadata, audio_codes, status = self.llm_handler.generate_with_5hz_lm(
                caption=caption,
                lyrics=lyrics,
    ...
    def generate_audio(
        ...
        try:
            ...
            result = self.dit_handler.generate_music(
                ...
                audio_duration=-1,
                batch_size=1,
                src_audio=reference_audio_path,
            ...
            # Unpack result: (audio_1, audio_2, batch_list, info, status, seed, ...)
